...
function tw_register_slider_cpt() {
...
add_action( 'init', 'tw_register_slider_cpt' );


function tw_enqueue_slider_assets() {
	if ( is_front_page() ) {
		...
		wp_enqueue_style(
			'tw-slider-hero',
			get_template_directory_uri() . '/../assets/css/slider-hero.css',
			array(),
			file_exists( get_template_directory() . '/../assets/css/slider-hero.css' )
				? filemtime( get_template_directory() . '/../assets/css/slider-hero.css' )
				: '1'
		);

		// JS del slider (DEPENDE DE SWIPER)
		wp_enqueue_script(
			'tw-slider-hero',
			get_template_directory_uri() . '/../assets/js/slider-hero.js',
			array( 'swiper' ),
			file_exists( get_template_directory() . '/../assets/js/slider-hero.js' )
				? filemtime( get_template_directory() . '/../assets/js/slider-hero.js' )
				: '1',
			true
		);
...
add_action( 'wp_enqueue_scripts', 'tw_enqueue_slider_assets' );
